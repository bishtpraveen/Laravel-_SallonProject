...
class user_dashboard extends Controller
{
    ...
    public function appointment_form()
    {
        ...
        Mail::send('email_view.appointment_email',$mail_send_array,function($m) use ($mail_send_array){
            ...
            $m->from('goodlookAdmin@gmail.com','Appointment Data');
        });
    ...
    public function latest_appointment_user()
    {
        ...
        $latest_appointment_get_query = appointment::where('appoint_user_email',Session::get('register_email'))->orWhere('appoint_user_email',Cookie::get('register_email'))->get();
