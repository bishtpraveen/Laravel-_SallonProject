				...
				<div class="col-lg-12 col-md-6 text-center" style='max-height:650px'>
					<div class="single-price">
						...
						<div class="end-sec">
							...
							<a class="primary-btn price-btn mt-40" onclick='appointment_btn("{{$special_service_data->id}}","{{$special_service_data->user_email}}","{{$special_service_data->shop_name}}")' >Order Now</a>
